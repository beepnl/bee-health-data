...
@section('content')
    ...
    <form method="POST" action="{{route('registration_invitations.update', $register_invitations)}}">
        @csrf
        @method('put')
        ...
        <div class="form-group">
            <label>Email</label>
            <input type="email" readonly class="form-control" value="{{$register_invitations->email}}">
        </div>
